...
// 	var settings = {
// 		"url": "http://dewdew.shop:80/questions/all",
// 		"method": "GET",
// 		"timeout": 0,
// 		"headers": {
// 		  "Authorization": 
...
function getQuestionDetail(page, size) {
	...
	var settings = {
		"url": 
		"http://dewdew.shop:80/questions/specific/"+localStorage.getItem('currentQuestion') + "?page=" + page + "&size=" + size,
		"method": "GET",
		"timeout": 0,
		"headers": {
...
function answerSummit() {
	var settings = {
		"url": "http://dewdew.shop:80/api/questions/"+localStorage.getItem('currentQuestion')+"/answers",
		"method": "POST",
		"timeout": 0,
		"headers": {
			"Authorization": localStorage.getItem('accessToken'),
...
function commentSummit(answerId) {
	var settings = {
		"url": "http://dewdew.shop:80/api/questions/answers/"+answerId+"/comments",
		"method": "POST",
		"timeout": 0,
		"headers": {
			"Authorization": localStorage.getItem('accessToken'),
...
function deleteQuestion() {
	var settings = {
		"url": "http://dewdew.shop:80/questions/"+localStorage.getItem('currentQuestion'),
		"method": "DELETE",
		"timeout": 0,
		"headers": {
			"Authorization": localStorage.getItem('accessToken'),
...
function deleteAnswer(answerId) {
	var settings = {
		"url": "http://dewdew.shop:80/api/answers/"+answerId,
		"method": "DELETE",
		"timeout": 0,
		"headers": {
			"Authorization": localStorage.getItem('accessToken'),
...
function deleteComment(answerId, commentId) {
	var settings = {
		"url": "http://dewdew.shop:80/api/questions/answers/"+answerId+"/comments/"+commentId,
		"method": "DELETE",
		"timeout": 0,
		"headers": {
			"Authorization": localStorage.getItem('accessToken'),
...
function likeAnswer(answerId) {
	...
	var settings = {
		"url": "http://dewdew.shop:80/api/likes/answer/"+answerId,
		"method": "POST",
		"timeout": 0,
		"headers": {
			"Authorization": localStorage.getItem('accessToken'),
...
function answerIsSelected(answerId) {
	var settings = {
		"url": "http://dewdew.shop:80/questions/"+localStorage.getItem('currentQuestion')+"/"+answerId,
		"method": "PATCH",
		"timeout": 0,
		"headers": {
			"Authorization": localStorage.getItem('accessToken'),
